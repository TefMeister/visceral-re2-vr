...
local cfg = {
    enabled = true,         -- aim-walk speed-up on by default (user-confirmed, screenshot 2026-08-30)
    ...
    aim_speed_mult = 1.0,      -- 1.3 was user-tuned for the old aim SHUFFLE; since 2026-09-24 aiming plays the
                               -- ordinary walk clip (item 22), so aim-walk must move at walk speed: 1.0 = off.
                               -- Measured 2026-09-24: 1.3x gave 2.3 m/s under a 1.7 m/s walk animation = sliding feet.
    smoothing = 0.4,
